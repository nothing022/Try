...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    draw.text((2100, 1420), f"Name:  {user_names}", fill=white, font=font)
    draw.text((2100, 1420), f"User Id:  {user_id}", fill=white, font=font)
    draw.text((2100, 1420), f"Username:  {user_username}", fill=white, font=font)
